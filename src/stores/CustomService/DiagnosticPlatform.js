...
import { queryTree , insert, update, remove, queryList, queryDetail, download,Calculate } from '@/services/CustomService/DiagnosticPlatform';
import { queryMenuButton, queryMenuList } from '@/services/global';

class DiagnosticPlatformStore {
  // 鉴权菜单按钮
...
export default new DiagnosticPlatformStore();
