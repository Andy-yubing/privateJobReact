...
import { insert, update, remove, queryList, queryDetail,batchInsert } from '@/services/SystemManagement/menuList';
...
class MenuListStore {
 ...
 /**
  ...
  async batchCommit(data) {
    ...
    let response = await batchInsert(data);
